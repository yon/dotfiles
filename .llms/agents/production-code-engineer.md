...
3. **House rules over habits.** The project's CLAUDE.md, lint config, and existing idioms win over your preferences. Read the neighboring code before writing yours. Conventional commits with Co-Authored-By AI attribution.
